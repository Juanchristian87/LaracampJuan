...
<body>
                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 text-center">
                            <a href="#">
                                <img src="/public/assets/images/banner.png" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="/public/assets/images/ic_globe.png" class="icon" alt="">
                        <h3 class="title">
                            Diversity
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="/public/assets/images/ic_globe-1.png" class="icon" alt="">
                        <h3 class="title">
                            A.I Guideline
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="/public/assets/images/ic_globe-2.png" class="icon" alt="">
                        <h3 class="title">
                            1-1 Mentoring
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="/public/assets/images/ic_globe-3.png" class="icon" alt="">
                        <h3 class="title">
                            Future Job
                        </h3>
                        <p class="support">
    ...
    <section class="steps">
        <div class="container">
            <div class="row item-step pb-70">
                <div class="col-lg-6 col-12 text-center">
                    <img src="/public/assets/images/step1.png" class="cover" alt="">
                </div>
            ...
            <div class="row item-step pb-70">
                ...
                <div class="col-lg-6 col-12 text-center">
                    <img src="/public/assets/images/step2.png" class="cover" alt="">
                </div>

            </div>
            <div class="row item-step">
                <div class="col-lg-6 col-12 text-center">
                    <img src="/public/assets/images/step3.png" class="cover" alt="">
                </div>
                <div class="col-lg-6 col-12 text-left copywriting">
                    <p class="story">
                        END GAME
    ...
    <section class="pricing">
        <div class="container">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <div class="item-benefit-pricing mb-4">
                                    <img src="/public/assets/images/ic_check.svg" alt="">
                                    <p>
                                        Pro Techstack Kit
                                    </p>
                                    <div class="clear"></div>
            ...
            <div class="row pb-70">
                <div class="col-lg-12 col-12 text-center">
                    <img src="/public/assets/images/brands.png" height="30" alt="">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="/public/assets/images/angga.png" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Angga
                                        </h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="/public/assets/images/beatrice.png" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Beatrice
                                        </h4>
