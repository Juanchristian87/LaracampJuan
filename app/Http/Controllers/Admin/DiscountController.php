...
class DiscountController extends Controller
{
    ...
    {
        $discount = Discount::create($request->all());//untuk memasukkan data ke table discount
    ...
    {
        $discount->update($request->all());//ini untuk update data yang ada di database
